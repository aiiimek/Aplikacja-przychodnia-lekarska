...
function modules() {
  ...
  // Bootstrap SCSS
  var bootstrapSCSS = gulp.src('./node_modules/bootstrap/sassets/css/**/*')
    .pipe(gulp.dest('./assets/vendor/bootstrap/scss'));
  // ChartJS
  var chartJS = gulp.src('./node_modules/chart.assets/js/dist/*.js')
    .pipe(gulp.dest('./assets/vendor/chart.js'));
  // dataTables
  var dataTables = gulp.src([
      './node_modules/datatables.net/assets/js/*.js',
      './node_modules/datatables.net-bs4/assets/js/*.js',
      './node_modules/datatables.net-bs4/assets/css/*.css'
    ])
